      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden p-6 space-y-6 scrollbar-thin">
          <div>
            ...
            <p className="text-slate-400">Access all AI-powered automation and security tools</p>
          </div>
                ...
                <Card className="bg-slate-900 border-slate-800 hover:border-slate-700 transition-all cursor-pointer h-full">
                  <CardContent className="p-6">
                    <div className="flex flex-col items-center text-center space-y-4">
                      ...
                      {/* Open Button */}
                      <button className="w-full mt-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded transition-colors">
                        Open
                      </button>
                    </div>
                  </CardContent>
