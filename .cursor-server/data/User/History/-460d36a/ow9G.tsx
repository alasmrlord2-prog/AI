...
export default function PerformanceTunerPage() {
  ...
  const loadAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch(`${getApiUrl()}/api/performance/tuner/analyze`, {
        headers: {
                                ...
                                <div>
                                  <div className="flex items-center gap-2 mb-2">
                                    <span className={`px-2 py-1 rounded text-xs ${
                                      rec.severity === "critical" ? "bg-red-900 text-red-200" :
                                      rec.severity === "high" ? "bg-orange-900 text-orange-200" :
                                  ...
                                  <p className="text-sm text-slate-300 mt-1">{rec.recommendation}</p>
                                  {rec.action && (
