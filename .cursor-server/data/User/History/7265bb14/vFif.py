...
try:
    ...
    print(f"[MAIN] WARNING: Failed to import CRM router: {e}")
    crm_router = None
except Exception as e:
    print(f"[MAIN] ERROR: Exception importing CRM router: {type(e).__name__}: {e}")
    import traceback
    traceback.print_exc()
    crm_router = None
try:
...
if crm_router:
    ...
    print(f"[MAIN] CRM router included in app")
else:
    print(f"[MAIN] WARNING: CRM router is None, not including")
