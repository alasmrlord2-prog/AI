...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-slate-900 h-screen p-6 border-r border-slate-800 hidden md:block flex flex-col overflow-hidden">
      ...
      <nav className="space-y-3 flex-1 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-slate-900 hover:scrollbar-thumb-slate-600">
        {item("/", "Agent Console")}
