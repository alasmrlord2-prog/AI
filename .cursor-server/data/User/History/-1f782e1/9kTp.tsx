...
export default function Sidebar() {
        ...
        <div key={uniqueKey} className="space-y-0.5">
          <button
            ...
            className={`w-full flex items-center justify-between px-3 py-2 rounded-lg transition-all duration-200 text-left group ${
              active
                ? "bg-[oklch(0.65_0.22_264)] text-white shadow-sm"
                : "text-[oklch(0.70_0_0)] hover:text-white hover:bg-[oklch(0.18_0_0)]"
            }`}
            ...
            <span className="flex items-center gap-2.5">
              {item.icon && (
                <span className={`transition-colors ${
                  active ? "text-white" : "text-[oklch(0.60_0_0)] group-hover:text-white"
                }`}>
                  {item.icon}
                </span>
              )}
          ...
          {isExpanded && (
            <div className="ml-2 space-y-0.5 mt-0.5 border-l border-[oklch(1_0_0_/_0.08)] pl-2">
  ...
  return (
    <aside
      className="w-64 bg-[oklch(0.11_0_0)] h-screen border-r border-[oklch(1_0_0_/_0.10)] hidden md:flex flex-col overflow-hidden"
      suppressHydrationWarning
    >
      {/* Header */}
      <div className="flex-shrink-0 px-6 py-5 border-b border-[oklch(1_0_0_/_0.10)]">
        ...
        <div className="space-y-6">
          {menuGroups.map((group) => (
            <div key={group.title} className="space-y-1.5">
              <h3 className="text-[10px] font-bold text-[oklch(0.50_0_0)] uppercase tracking-wider px-3 py-1.5">
                {group.title}
              </h3>
