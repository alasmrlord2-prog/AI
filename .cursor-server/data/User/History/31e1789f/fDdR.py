...
async def get_threat_summary(
    ...
    try:
        ...
        # Run threat summary calculation in executor with reasonable timeout (max 10 seconds)
        ...
        # Return default summary on timeout
        print("Timeout getting threat summary - using defaults")
        return {
            "total_threats": 0,
            "critical": 0,
            "high": 0,
