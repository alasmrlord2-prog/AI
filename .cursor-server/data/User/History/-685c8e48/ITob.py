...
async def api_siem_monitor(current_user: dict = Depends(get_current_user)):
    ...
    result = security_service.get_siem_data()
    return result
...
async def api_scan_port_scan(
    ...
    try:
        result = security_service.scan_ports(target)
...
async def api_scan_penetration_test(
    ...
    try:
        result = security_service.scan_penetration()
...
async def api_network_forensics(
    ...
    try:
        result = security_service.network_forensics("")  # Empty for traffic analysis
...
async def api_advanced_vulnerability(
    ...
    try:
        result = security_service.advanced_vulnerability_scan()
...
async def api_web_scan(
    ...
    try:
        result = security_service.web_vulnerability_scan(url)
...
async def api_advanced_container(
    ...
    try:
        result = security_service.advanced_container_scan()
...
async def api_kubernetes(
    ...
    try:
        result = security_service.kubernetes_scan()
...
async def api_aws(
    ...
    try:
        result = security_service.aws_scan()
...
async def api_memory_forensics(
    ...
    try:
        result = security_service.memory_forensics()
...
async def api_disk_forensics(
    ...
    try:
        result = security_service.disk_forensics(path)
...
async def api_password_audit(
    ...
    try:
        result = security_service.password_audit()
...
async def api_compliance(
    ...
    try:
        result = security_service.compliance_check(standard)
...
async def api_burp_suite(
    ...
    try:
        result = security_service.burp_scan(url)
...
async def api_metasploit(
    ...
    try:
        result = security_service.metasploit_scan(target, port)
...
async def api_packet_analysis(
    ...
    try:
        result = security_service.network_forensics(file_path)
