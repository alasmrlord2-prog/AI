...
# Start required services first (postgres, ollama, backend)
echo "📦 Starting required services (postgres, ollama, backend)..."
docker-compose -f "$COMPOSE_FILE" up -d postgres ollama backend
