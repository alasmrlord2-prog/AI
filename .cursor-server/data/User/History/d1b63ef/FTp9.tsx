  ...
  const fetchData = async () => {
    try {
      const [networkData, archData, metricsData] = await Promise.all([
        apiRequest("/api/visualization/network-map", {}, 5000).catch(() => null),
        apiRequest("/api/visualization/architecture", {}, 5000).catch(() => null),
        apiRequest("/api/visualization/metrics", {}, 5000).catch(() => null)
      ]);
