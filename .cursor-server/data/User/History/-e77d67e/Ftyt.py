    ...
    def get_stats_data():
        try:
            ...
            try:
                ...
                # If all methods fail, return error status instead of default value
                security_health = -1  # Use -1 to indicate error, not a default value
            
            return {
                "total_modules": modules_count,
                "ai_status": ai_status,
                "ai_status_text": ai_status_text,
                "security_health": round(security_health, 1) if security_health >= 0 else None
            }
        except Exception as e:
