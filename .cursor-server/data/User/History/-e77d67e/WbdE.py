        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    # Use quick summary with timeout protection
                    import signal
                    
                    def get_summary_with_timeout():
                        try:
                            return threat_detector.get_threat_summary(24)
                        except:
                            return None
                    
                    # Try to get summary, but don't wait too long
                    threat_summary = get_summary_with_timeout()
