...
export default function ApprovalsPage() {
  ...
  const loadActions = async () => {
    ...
    try {
      ...
      const res = await fetch(`${getApiUrl()}/api/pending-actions`, {
        headers: {
  ...
  const handleApprove = async (actionId: string) => {
    try {
      ...
      const res = await fetch(`${getApiUrl()}/api/pending-actions/${actionId}/approve`, {
        method: "POST",
        headers: {
          "Authorization": `Bearer ${token}`,
  ...
  const handleReject = async (actionId: string) => {
    ...
    try {
      const token = getAuthToken();
      const res = await fetch(`${getApiUrl()}/api/pending-actions/${actionId}/reject`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`,
