...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 aria-invalid:ring-red-500/20",
  {
    variants: {
      variant: {
        default: "bg-indigo-500 text-white hover:bg-indigo-600 active:bg-indigo-700 shadow-sm hover:shadow-md",
        destructive:
          "bg-red-500 text-white hover:bg-red-600 active:bg-red-700 shadow-sm hover:shadow-md focus-visible:ring-red-500",
        outline:
          "border border-slate-700 bg-slate-900 text-slate-200 shadow-xs hover:bg-slate-800 hover:text-white hover:border-indigo-500",
        secondary:
