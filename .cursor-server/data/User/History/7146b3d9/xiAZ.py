...
FEATURE_PERMISSIONS: Dict[str, Dict] = {
    ...
    "security.file_integrity_scan": {
        "tools": ["read_file", "run_shell"],
        "description": "File integrity scan"
    },
    "security.malware_scan": {
        "tools": ["read_file", "run_shell"],
        "description": "Malware scan"
    },
    "security.intrusion_detection_scan": {
        "tools": ["read_file", "run_shell"],
        "description": "Intrusion detection scan"
    },
    "security.port_scan": {
        "tools": ["run_shell"],
    ...
    "security.threat_intelligence_scan": {
        "tools": ["run_shell"],
        "description": "Threat intelligence scan"
    },
    "security.network_forensics": {
        "tools": ["read_file", "run_shell"],
        "description": "Network forensics"
    },
    "security.advanced_vulnerability_scan": {
        "tools": ["read_file", "run_shell"],
    ...
    "security.advanced_container_scan": {
        "tools": ["read_file", "run_shell"],
        "description": "Advanced container scan"
    },
    "security.kubernetes_scan": {
        "tools": ["read_file", "run_shell"],
        "description": "Kubernetes security scan"
    },
    "security.aws_scan": {
        "tools": ["read_file", "run_shell"],
        "description": "AWS security scan"
    },
    "security.memory_forensics": {
        "tools": ["read_file", "run_shell"],
        "description": "Memory forensics",
        "requires_approval": True
    },
    "security.disk_forensics": {
        "tools": ["read_file", "run_shell"],
    ...
    "security.burp_suite_scan": {
        "tools": ["run_shell"],
        "description": "Burp Suite web scan",
        "requires_approval": True
    },
    "security.metasploit_scan": {
        "tools": ["run_shell"],
        "description": "Metasploit exploit scan",
        "requires_approval": True
    },
    "security.packet_analysis": {
        "tools": ["read_file", "run_shell"],
