...
export const apiRequest = async (
  ...
  if (lastError) {
    ...
    const errorStack = lastError?.stack || 'No stack trace';
    
    // Log the error for debugging - properly serialize error object
    try {
      console.error('[API] Request failed:', {
        ...
        fullError: lastError instanceof Error ? {
          name: lastError.name,
      ...
      console.error('[API] Request failed (fallback log):', {
        endpoint,
        apiUrl: getApiUrl(),
        errorMessage,
