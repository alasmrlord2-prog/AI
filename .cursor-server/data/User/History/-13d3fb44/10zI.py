...
async def monitor_status():
    ...
    # Get base monitoring data with timeout protection (max 3 seconds - reduced for faster response)
    try:
    ...
    # Add network monitoring with timeout protection (max 2 seconds - reduced for faster response)
    try:
        loop = asyncio.get_event_loop()
