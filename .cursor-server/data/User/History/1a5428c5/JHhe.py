...
try:
    ...
    class CryptContext:
        ...
        def verify(self, plain, hashed):
            ...
            return hashlib.sha256(plain_bytes).hexdigest() == hashed
        ...
        if not os.path.exists(USERS_FILE):
            ...
            try:
                if BCRYPT_AVAILABLE:
                    ...
                    password_to_hash = default_password[:72]
...
def verify_password(plain_password: str, hashed_password: str) -> bool:
    ...
    try:
        if BCRYPT_AVAILABLE:
            ...
            password_to_check = plain_password[:72]
            ...
            test_hash = hashlib.sha256(password_bytes).hexdigest()
