...
export default function ServicesDrawer({
  ...
  return (
    <>
      ...
      <div
        className="fixed top-0 left-0 h-full w-80 bg-sw-bg-sidebar shadow-xl border-r border-sw-border transition-transform duration-300 ease-out z-[60] animate-slide-in"
      >
