...
async def create_tenant(
    ...
    from app.crm.workflow_triggers import WorkflowTriggerService
    trigger = WorkflowTriggerService.trigger_on_tenant_created(db, tenant.id)
    # In production, send trigger to workflow engine
...
async def add_user_to_tenant(
    ...
    # Trigger workflow event
    from app.crm.workflow_triggers import WorkflowTriggerService
    trigger = WorkflowTriggerService.trigger_on_user_added(db, tenant_id, user_id, role)
    # In production, send trigger to workflow engine
