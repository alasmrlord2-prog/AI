...
async def approve_pending_action(
    ...
    try:
        ...
        elif tool_name.startswith("security.") or tool_name.startswith("cicd.") or tool_name.startswith("backup."):
            action_name = tool_name
            logger.info(f"Action-based request: {action_name}")
            # For action-based requests, we mark as approved but don't execute here
            # The actual execution should happen in the respective API endpoint
