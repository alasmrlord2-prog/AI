...
#from core_llm import llm
#from tools import read_file, check_service, run_shell, doc_search, read_logs, monitor
...
from tools.doc_search import run as doc_search_run
from tools.read_logs import run as read_logs_run
