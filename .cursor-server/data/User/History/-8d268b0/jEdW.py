    ...
    try:
        ...
        if not os.path.exists(path):
            ...
            if path.startswith('/home/ai/ai-agent/'):
                # نحاول البحث في المسار الحالي أولاً
                ...
                for alt_path in alt_paths:
                    ...
                    return f"[Errno 2] No such file or directory: '{path}'\n💡 Tip: Current directory is '{current_dir}'. The file might not be mounted in the container. Try:\n- Relative path from current directory\n- Or mount the directory in docker-compose.yml"
