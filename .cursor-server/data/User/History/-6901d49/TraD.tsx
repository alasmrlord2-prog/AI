...
export default function MonitoringPage() {
  ...
  const handleAutoRepairService = async () => {
    ...
    try {
      const res = await fetch(`${getApiUrl()}/api/monitor/auto-repair/service/${serviceName}`, {
        method: "POST"
      });
  ...
  const handleAutoRepairContainer = async () => {
    ...
    try {
      const res = await fetch(`${getApiUrl()}/api/monitor/auto-repair/container/${containerName}`, {
        method: "POST"
      });
  ...
  const handleCheckService = async () => {
    ...
    try {
      const res = await fetch(`${getApiUrl()}/api/monitor/service-status/${serviceName}`);
      if (res.ok) {
        const data = await res.json();
  ...
  const handleCheckContainer = async () => {
    ...
    try {
      const res = await fetch(`${getApiUrl()}/api/monitor/container-status/${containerName}`);
      if (res.ok) {
        const data = await res.json();
