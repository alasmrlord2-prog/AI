...
export default function Home() {
  ...
  useEffect(() => {
    const fetchDashboardStats = async () => {
      ...
      try {
        const incidentsData = await apiRequest("/api/incidents/stats/today", { method: "GET" }, 10000);
      ...
      try {
        const threatsData = await apiRequest("/api/security/threat-detection/summary?hours=24", { method: "GET" }, 10000);
      ...
      try {
        const hardeningData = await apiRequest("/api/security/hardening/status", { method: "GET" }, 10000);
      ...
      try {
        const behaviorData = await apiRequest("/api/alerts/behavior/?resolved=false&hours=24", { method: "GET" }, 10000);
