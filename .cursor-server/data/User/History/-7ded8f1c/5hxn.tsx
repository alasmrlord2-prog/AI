...
export default function Home() {
  ...
  const sendQuery = async () => {
    ...
    try {
      ...
      }, 60000); // 60 second timeout for chat (AI responses can take longer)
      ...
      if (errorMessage.includes("timeout")) {
        updateLastAgentMessage("⏱️ استغرق الرد وقتاً طويلاً. يرجى المحاولة مرة أخرى أو تبسيط السؤال.\n\n💡 نصائح:\n- تحقق من اتصال الإنترنت\n- جرب سؤالاً أقصر\n- تأكد من أن الـ Backend يعمل");
          ...
          <Card className="bg-slate-900 border-slate-800">
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
                <a href="/threat-detection" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">🤖</div>
                  <div className="text-xs">Threat Detection</div>
                </a>
                <a href="/abac" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">🛡️</div>
                  <div className="text-xs">ABAC</div>
                </a>
                <a href="/cost-analyzer" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">💰</div>
                  <div className="text-xs">Cost Analyzer</div>
                </a>
                <a href="/performance-tuner" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">🎛️</div>
                  <div className="text-xs">Performance</div>
                </a>
                <a href="/global-search" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">🔍</div>
                  <div className="text-xs">Global Search</div>
                </a>
                <a href="/plugins" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">🧩</div>
                  <div className="text-xs">Plugins</div>
                </a>
                <a href="/workflow-builder" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">🔧</div>
                  <div className="text-xs">Workflows</div>
                </a>
                <a href="/snapshots" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">📸</div>
                  <div className="text-xs">Snapshots</div>
                </a>
                <a href="/agent-mesh" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">🌐</div>
                  <div className="text-xs">Agent Mesh</div>
                </a>
                <a href="/digital-twin" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">🌍</div>
                  <div className="text-xs">Digital Twin</div>
                </a>
                <a href="/code-review" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">🔍</div>
                  <div className="text-xs">Code Review</div>
                </a>
                <a href="/blueprints" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">📋</div>
