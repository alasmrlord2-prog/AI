...
export default function Home() {
  ...
  useEffect(() => {
    const fetchDashboardStats = async () => {
      ...
      // Fetch dashboard stats (modules, AI status, security health) - increased timeout to 15s
      try {
        const dashboardStats = await apiRequest("/api/dashboard/stats", { method: "GET" }, 15000);
