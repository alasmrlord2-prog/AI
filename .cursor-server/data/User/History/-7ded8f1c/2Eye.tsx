      ...
      try {
        ...
        if (data) {
          ...
          if (data.cpu_percent !== undefined) {
            setCpuHistory((prev) => [...prev.slice(-19), { label: now, value: data.cpu_percent }]);
          }
          if (data.memory_percent !== undefined) {
            setMemoryHistory((prev) => [...prev.slice(-19), { label: now, value: data.memory_percent }]);
          }
        }
      } catch (e) {
        // Ignore errors
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 md:gap-4">
            <Card className="bg-slate-900 border-slate-800">
              <CardContent className="p-4">
                ...
                <div className="text-3xl font-bold mt-2 text-blue-400">31</div>
                <div className="text-xs text-slate-500 mt-1">Active Features</div>
              </CardContent>
            </Card>
            <Card className="bg-slate-900 border-slate-800">
              <CardContent className="p-4">
                <div className="text-sm text-slate-400">AI Status</div>
            ...
            <Card className="bg-slate-900 border-slate-800">
              <CardContent className="p-4">
                <div className="text-sm text-slate-400">Security Health</div>
            ...
            <Card className="bg-slate-900 border-slate-800">
              <CardContent className="p-4">
                ...
                <div className="text-3xl font-bold mt-2 text-yellow-400">2</div>
                <div className="text-xs text-slate-500 mt-1">Resolved</div>
              </CardContent>
            </Card>
            <Card className="bg-slate-900 border-slate-800">
              <CardContent className="p-4">
                <div className="text-sm text-slate-400">CPU / RAM</div>
              ...
              <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-3">
                {quickAccessItems.map((item, index) => (
                  <Link
                    ...
                    href={item.href}
                    prefetch={true}
                    className="p-4 bg-slate-800 rounded hover:bg-slate-700 transition text-center cursor-pointer border border-slate-700 hover:border-slate-600"
