          ...
          <Card className="bg-slate-900 border-slate-800">
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
                <Link href="/threat-detection" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">🤖</div>
                  <div className="text-xs">Threat Detection</div>
                </Link>
                <Link href="/abac" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">🛡️</div>
                  <div className="text-xs">ABAC</div>
                </Link>
                <Link href="/cost-analyzer" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">💰</div>
                  <div className="text-xs">Cost Analyzer</div>
                </Link>
                <Link href="/performance-tuner" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">🎛️</div>
                  <div className="text-xs">Performance</div>
                </Link>
                <Link href="/global-search" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">🔍</div>
                  <div className="text-xs">Global Search</div>
                </Link>
                <Link href="/plugins" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">🧩</div>
                  <div className="text-xs">Plugins</div>
                </Link>
                <Link href="/workflow-builder" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">🔧</div>
                  <div className="text-xs">Workflows</div>
                </Link>
                <Link href="/snapshots" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">📸</div>
                  <div className="text-xs">Snapshots</div>
                </Link>
                <Link href="/agent-mesh" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">🌐</div>
                  <div className="text-xs">Agent Mesh</div>
                </Link>
                <Link href="/digital-twin" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">🌍</div>
                  <div className="text-xs">Digital Twin</div>
                </Link>
                <Link href="/code-review" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">🔍</div>
                  <div className="text-xs">Code Review</div>
                </Link>
                <Link href="/blueprints" className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center">
                  <div className="text-2xl mb-1">📋</div>
