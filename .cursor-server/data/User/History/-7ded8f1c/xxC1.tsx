...
export default function Home() {
  ...
  const sendQuery = async () => {
    ...
    // Update loading messages at intervals - longer intervals for slow processing without GPU
    ...
    loadingTimeouts.push(setTimeout(() => {
      updateLastAgentMessage("⏳ المعالجة مستمرة... يرجى الانتظار، الـ Agent سيرد حتى لو تأخر.");
    }, 60000)); // 1 minute
    
    loadingTimeouts.push(setTimeout(() => {
      updateLastAgentMessage("⏳ لا يزال يعمل... المعالجة قد تستغرق عدة دقائق بدون GPU. الـ Agent سيرد قريباً.");
    }, 120000)); // 2 minutes

    try {
      // No timeout for chat - let it wait as long as needed for AI response
      // Especially important when no GPU is available and processing is slow
      const data = await apiRequest("/api/chat", {
        method: "POST",
        body: JSON.stringify({ message: textToSend }),
      }, 600000); // 10 minutes timeout - enough time for slow AI processing without GPU
      ...
      if (errorMessage.includes("timeout")) {
        updateLastAgentMessage("⏱️ استغرق الرد وقتاً طويلاً جداً (أكثر من 10 دقائق).\n\n💡 نصائح:\n- الـ Agent لا يزال يعمل، يمكنك المحاولة مرة أخرى\n- تحقق من اتصال الإنترنت\n- تأكد من أن الـ Backend يعمل بشكل صحيح\n- بدون GPU، المعالجة قد تستغرق وقتاً أطول\n\n🔄 يمكنك المحاولة مرة أخرى - الـ Agent سيرد حتى لو تأخر");
    ...
    <main className="flex bg-slate-950 text-slate-200 h-screen w-screen overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden p-6 space-y-6 scrollbar-thin">
          {/* Dashboard Overview - Optimized for fast rendering */}
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
                <Link 
                  ...
                  prefetch={true}
                  className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center cursor-pointer"
                  onMouseEnter={() => router.prefetch("/threat-detection")}
                >
                ...
                <Link 
                  ...
                  prefetch={true}
                  className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center cursor-pointer"
                  onMouseEnter={() => router.prefetch("/abac")}
                >
                ...
                <Link 
                  ...
                  prefetch={true}
                  className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center cursor-pointer"
                  onMouseEnter={() => router.prefetch("/cost-analyzer")}
                >
                  <div className="text-2xl mb-1">💰</div>
                  <div className="text-xs">Cost Analyzer</div>
                </Link>
                <Link 
                  href="/performance-tuner" 
                  prefetch={true}
                  className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center cursor-pointer"
                  onMouseEnter={() => router.prefetch("/performance-tuner")}
                >
                  <div className="text-2xl mb-1">🎛️</div>
                ...
                <Link 
                  ...
                  prefetch={true}
                  className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center cursor-pointer"
                  onMouseEnter={() => router.prefetch("/global-search")}
                >
                  <div className="text-2xl mb-1">🔍</div>
                ...
                <Link 
                  ...
                  prefetch={true}
                  className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center cursor-pointer"
                  onMouseEnter={() => router.prefetch("/plugins")}
                >
                  <div className="text-2xl mb-1">🧩</div>
                ...
                <Link 
                  ...
                  prefetch={true}
                  className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center cursor-pointer"
                  onMouseEnter={() => router.prefetch("/workflow-builder")}
                >
                  <div className="text-2xl mb-1">🔧</div>
                ...
                <Link 
                  ...
                  prefetch={true}
                  className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center cursor-pointer"
                  onMouseEnter={() => router.prefetch("/snapshots")}
                >
                  <div className="text-2xl mb-1">📸</div>
                ...
                <Link 
                  ...
                  prefetch={true}
                  className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center cursor-pointer"
                  onMouseEnter={() => router.prefetch("/agent-mesh")}
                >
                  <div className="text-2xl mb-1">🌐</div>
                ...
                <Link 
                  ...
                  prefetch={true}
                  className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center cursor-pointer"
                  onMouseEnter={() => router.prefetch("/digital-twin")}
                >
                  <div className="text-2xl mb-1">🌍</div>
                ...
                <Link 
                  ...
                  prefetch={true}
                  className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center cursor-pointer"
                  onMouseEnter={() => router.prefetch("/code-review")}
                >
                  <div className="text-2xl mb-1">🔍</div>
                ...
                <Link 
                  ...
                  prefetch={true}
                  className="p-3 bg-slate-800 rounded hover:bg-slate-700 transition text-center cursor-pointer"
                  onMouseEnter={() => router.prefetch("/blueprints")}
                >
                  <div className="text-2xl mb-1">📋</div>
