      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden p-4 md:p-6 space-y-4 md:space-y-6 scrollbar-thin min-h-0">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 md:gap-4">
            ...
            <Card className="bg-sw-bg-card border-sw-border shadow-sw-card dark:shadow-sw-card-dark col-span-2 sm:col-span-1">
              <CardContent className="p-3 md:p-4">
          ...
          <Card className="bg-sw-bg-card border-sw-border shadow-sw-card dark:shadow-sw-card-dark">
            <CardHeader>
              <CardTitle className="text-base md:text-lg text-sw-text-strong">Quick Access</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-2 md:gap-3">
                {quickAccessItems.map((item, index) => (
                  <Link
                    ...
                    href={item.href}
                    prefetch={true}
                    className="p-3 md:p-4 bg-sw-bg-soft rounded-md hover:bg-sw-bg-hover transition text-center cursor-pointer border border-sw-border hover:border-sw-blue"
                    onMouseEnter={() => router.prefetch(item.href)}
                  >
                    <div className="text-2xl md:text-3xl mb-1 md:mb-2">{item.icon}</div>
                    <div className="text-xs md:text-sm font-medium text-sw-text">{item.label}</div>
                  </Link>
                ))}
              </div>
            </CardContent>
