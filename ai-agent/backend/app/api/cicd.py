...
async def run_pipeline(
    ...
    """Run a pipeline."""
    check_action_permission("cicd.build", current_user, resource=req.repo_name)
    try:
...
async def rollback_pipeline(
    ...
    check_action_permission("cicd.rollback", current_user, resource=pipeline_id)
...
async def deploy_docker_compose(
    ...
    check_action_permission("cicd.deploy", current_user, resource=req.compose_file)
...
async def deploy_kubernetes(
    ...
    check_action_permission("cicd.deploy", current_user, resource=req.manifest_file)
...
async def deploy_rsync(
    ...
    """Deploy using RSync."""
    check_action_permission("cicd.deploy", current_user, resource=req.destination)
