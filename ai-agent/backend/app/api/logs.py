...
async def get_logs(limit: int = 100):
    """Get last N lines from chat.log - optimized for large files with timeout protection."""
    import asyncio
    ...
    try:
        # Run in executor with timeout (max 5 seconds)
        ...
        print("Timeout reading logs - returning empty list")
        return []
    except Exception as e:
